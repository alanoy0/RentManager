...
public class ClientDao {
	...
	public long create(Client client) throws DaoException {
		long ret = 0;
		if (client.isAdult() && emailAlreadyExist(client) == false && client.lengthIsMoreThan3(client.getLastName())
				&& client.lengthIsMoreThan3(client.getFirstName())) {
			try {
...
public long edit(int id, Client client) throws DaoException {
	long ret = 0;
	if(client.isAdult() &&  client.lengthIsMoreThan3(client.getLastName()) && client.lengthIsMoreThan3(client.getFirstName())) {
