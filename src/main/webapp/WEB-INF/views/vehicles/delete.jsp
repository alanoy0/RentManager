                        ...
                        <form class="form-horizontal" method="post">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="manufacturer" class="col-sm-2 control-label">Id</label>
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="idVehicle" name="idVehicle" placeholder="identifiant" required>
                                    </div>
                               
                            </div>
                            <!-- /.box-body -->
                            <div class="box-footer">
                                <button type="submit" class="btn btn-info pull-right" id = "deleteVehicle">Supprimer</button>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
