                    ...
                    <div class="box">
                        ...
                        <form class="form-horizontal" method="post">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="seats" class="col-sm-2 control-label" id = "seatsVehicle">Nombre de places</label>
                            ...
                            <div class="box-footer">
                                <button type="submit" class="btn btn-info pull-right" id = "submitVehicle">Ajouter</button>
                            </div>
                            <!-- /.box-footer -->
                        </form>
                    </div>
